...
btn = document.getElementById("btn").addEventListener("click", analyzeInput)

function analyzeInput() {
    const input = document.getElementById("input").value;

    // Make sure to replace 'ENDPOINT_URL' with the actual URL of your endpoint
    const endpoint = '/analyze';

    // Create the request payload
    const payload = {
        "account_handler": input
    };
